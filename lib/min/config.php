...
if(!DEBUG_MODE) $min_cachePath = dirname(__FILE__).'/../../compiled';
...
/**
 * Disabilita il rewrite degli url nel css
 */
$min_serveOptions['rewriteCssUris'] = false;
$min_serveOptions['minifierOptions']['text/css']['prependRelativePath'] = '../../resource/img/';
